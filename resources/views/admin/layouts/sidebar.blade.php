...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ asset('AdminLTE-3.0.2/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
           ...
           with font-awesome or any other icon font library -->
                ...
                <li class="nav-item {{ (request()->routeIs('jenis_kasus.index')) ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('jenis_kasus.index') }}">
                        <i class="nav-icon fas fa-fw fa-newspaper"></i>
                        <p>Jenis Kasus</p>
                    </a>
                </li>
                ...
                <li class="nav-item {{ (request()->routeIs('users.roles_permission')) ? 'active' : '' }}">
